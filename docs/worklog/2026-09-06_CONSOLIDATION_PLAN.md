...
pool as `#pair-unit-dispatch` (`docs/worklog/2026-09-06_PAIR_UNIT_DISPATCH.md`):
...
## 3. Closed — measured, do not re-run
    ...
    last-carrier hold, WIDE form      reorders incumbents; its A/B       2026-09-06_LAST_CARRIER_HOLD.md
...
`exe_parity_convert` -- cited by `2026-09-01_AUDIT.md` as "rule 5", the standard
