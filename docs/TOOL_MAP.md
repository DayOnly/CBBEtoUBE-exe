...
**90** tracked measurement tools. **Check here before hand-rolling a probe.**
...
| tool | gate | floor | what it measures |
|---|---|---|---|
| `scripts/analysis/acceptance.py` | 2, 3 | yes | THE GATE. Two arms in, one verdict out, exit code = the verdict |
