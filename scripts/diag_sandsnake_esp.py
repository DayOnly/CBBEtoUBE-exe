...
FILES = [
    r"<MODLIST_ROOT>\mods\RB's Sand Snake Armor and Weapon\RB's Sand Snake CBBE 3BA Bodyslide ESPFE.esp",
    r"<MODLIST_ROOT>\mods\Authoria - Sand Snake Fixed Plugin\RB's Sand Snake CBBE 3BA Bodyslide ESPFE.esp",
    r"<MODLIST_ROOT>\mods\CBBEtoUBE Auto\_unmerged_patches\RB's Sand Snake CBBE 3BA Bodyslide ESPFE UBE patch.esp",
    r"<MODLIST_ROOT>\mods\CBBEtoUBE Auto\_unmerged_patches\Authoria - Rectificated - Sandsnake Armor UBE patch.esp",
]
