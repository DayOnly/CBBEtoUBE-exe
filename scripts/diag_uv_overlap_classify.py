...
REPO = Path(r"<USER_HOME>\Downloads\cbbe-to-ube")
sys.path.insert(0, str(REPO)); sys.path.insert(0, str(REPO / ".pynifly"))
from pyn import pynifly                       # noqa: E402
from src import overlay_transfer as ot        # noqa: E402

BODY = Path(r"<MODLIST_ROOT>\mods\Authoria - Nevernude Female 3BA\meshes\Actors\Character\Character Assets\femalebody_1.nif")
HEAD = Path(r"<MODLIST_ROOT>\mods\Expressive Facegen Morphs SE\meshes\actors\character\character assets\femalehead.nif")
TEXCONV = r"<MODLIST_ROOT>\tools\xEdit\Edit Scripts\Texconvx64.exe"
N = 256
TESTS = [
    ("BODY  WNB/Arcolis", r"<MODLIST_ROOT>\mods\Weathered Nordic Bodypaints SE\textures\actors\character\Overlays\WNB\Arcolis\Arcolis 1.dds"),
    ("FACE  FMS/Blush",   r"<MODLIST_ROOT>\mods\Female Makeup Suite - Face\textures\actors\character\Overlays\FMS\Blush\Anime Blush 1.dds"),
    ("FACE  Miggyluv",    r"<MODLIST_ROOT>\mods\Miggyluv's Facepaint for Men\Textures\Actors\Character\Overlays\Miggyluv\Mig_Face_DarkKnight_Eyes.dds"),
]
