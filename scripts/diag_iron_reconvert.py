...
SRC = Path(r"<MODLIST_ROOT>\mods\HDT-SMP Vanilla Armors\meshes\armor\iron\f\cuirasslight_1.nif")


def main():
    ube_body = nif_convert._find_ube_femalebody("_1") or Path(
        r"<MODLIST_ROOT>\mods\Authoria - Bodyslide Output - 3BA\meshes\!UBE\Body\femalebody_tangent_1.nif")
