...
SRC = Path(r"<MODLIST_ROOT>\mods\Authoria - Bodyslide Output - 3BA\meshes\armor\iron\f\cuirasslight_1.nif")
DEPLOYED = Path(r"<MODLIST_ROOT>\mods\CBBEtoUBE Auto\meshes\!UBE\armor\iron\f\cuirasslight_1.nif")
UBE_BODY = Path(r"<MODLIST_ROOT>\mods\Authoria - Bodyslide Output - 3BA\meshes\!UBE\Body\femalebody_tangent_1.nif")
