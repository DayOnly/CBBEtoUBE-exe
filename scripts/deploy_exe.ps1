...
# The list must equal STATE_FILE_GLOBS in scripts/release_gate.py (a test pins
# the two). MEASURED 2026-09-15 on a scratch copy: the narrower list it replaced
# ("CBBEtoUBE_*run.log", "CBBEtoUBE_settings.json.bak-*") let a dist-side copy
# overwrite the live CBBEtoUBE_settings.json.bak, CBBEtoUBE_gui_session.log,
# CBBEtoUBE_cli.log and CBBEtoUBE_glowdebug.log; only the run logs survived.
$stateFiles = @(
