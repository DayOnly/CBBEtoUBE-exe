...
os.environ.setdefault("CBBE2UBE_MODS_ROOT", r"<MODLIST_ROOT>\mods")
...
UBE_DIR = Path(r"<MODLIST_ROOT>\mods\UBE 2.0 U. 0.7\CalienteTools"
...
SRC = Path(r"<MODLIST_ROOT>\mods\Authoria - Bodyslide Output - 3BA"
...
TRI = Path(r"<MODLIST_ROOT>\mods\CBBEtoUBE Auto\meshes\!UBE"
