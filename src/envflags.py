...
Since 2026-09-16 every boolean and numeric read in src/ goes through these two
helpers (77 names in 15 modules were read raw before, invisible to the flag
censuses); the twelve path and string reads that stay raw are listed, with a
reason each, in tests/test_raw_env_reads.py, and that test is a ratchet with a
negative control. #env-through-helpers
