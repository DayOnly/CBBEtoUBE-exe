...
balloons a rigid bust (Moon Monk robe: 60% chain bones overall but bust
...
def test_no_bust_keeps_softcloth():
    ...
    sh = _Shape("Skirt", [(0.0, 7.0, 95.0)] * 3, {"FVOOa 3": [(0, 1.0)]})
    assert nc._shape_bust_is_softbody_driven(sh, BODY, set()) is True
